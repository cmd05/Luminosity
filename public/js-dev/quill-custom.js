 ...
 */
import { newTokenData, URL, isJson, dataURLtoFile } from './script.js';
                            ...
                            handlers: {
                                ...
                                image: function image() {
                                    ...
                                    if (fileInput == null) {
                                        ...
                                        fileInput.setAttribute('accept', 'image/png, image/gif, image/jpeg, image/bmp, image/x-icon', 'image/webp');
                                            ...
                                            if (fileInput.files != null && fileInput.files[0] != null) {
                                                ...
                                                reader.onload = function(e) {
                                                    const exec = async _ => {
                                                        ...
                                                        toast.querySelector('.toast-body').innerHTML = 'Uploading Image   <i class="fas fa-circle-notch fa-spin"></i>';
                                                        ...
                                                        async function fetchUrl(file) {
                                                            ...
                                                            const response = await fetch(`${URL}/ajax/write/upload-image`, { method: "POST", body: formData });
                                                        ...
                                                        toast.querySelector('.toast-body').innerHTML = 'Error Occured';
                                                        if (isJson(json)) {

<?php View::header(true, "Forgot Password") ?>
...
<form action="<?= URLROOT ?>/user/forgot-password" method='POST' id='page-form' class='mt-3'>
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control <?= !empty($data['error']) ?  'is-invalid' : ''?>" name='email' placeholder="Email Address" value="<?=ht($data['email'])?>">

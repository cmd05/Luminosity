<?php View::header(false, 'Register') ?>
<?php require_once(APPROOT.'/Views/inc/guest/sign-up-navbar.php') ?>
<link rel="stylesheet" href="<?=URLROOT?>/css/sign-up.css">
<main class="sign-up">
	<section id="section_1">
		<h3 class="text-center p-0 m-0 mb-5">Create An Account</h3>
		<div class="form-group mb-3">
			<label for="email" class='mb-2'>Email</label>
			<input type="text" class="form-control form-input" name='email' placeholder="" data-error='email_err'>
		...
		<div class="form-group mb-3">
			...
			<div class="input-group">
				<input type="password" class="form-control form-input" placeholder="" name='password' id='pwd-input' data-error='password_err'>
		...
		<div class="form-group mb-4">
			...
			<input type="password" class="form-control form-input" placeholder="" name='confirm_password' data-error='confirm_password_err'>
	...
	<section id="section_2">
		...
		<div class="form-group mb-4">
			...
			<input type="text" class="form-control" name='display_name' placeholder=""  data-error='display_name_err'>
			<small class="mt-2 d-block invalid-feedback" name='display_name_err'>
			</small>
		</div>
		<div class="form-group mb-3">
			<label for="email" class='mb-2'>Username</label>
			<input type="text" class="form-control" name='username' placeholder=""  data-error='username_err'>

...
class Write extends ProtectedController {
	...
	public function submitArticle() {
		...
		if(Str::emptyStrings($data)) {
			// Upload Article
			$prev = Html::getTagResults($content, "img")[0] ? Html::getTagResults($content, "img")[0]->getAttribute("src") : "";
			$articleId = $this->writeModel->createArticle($title, $tagline, $content, $prev);
